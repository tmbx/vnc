...
#define WINVNC_REGISTRY_KEY "Software\\teambox\\kcs\\vnc\\server"
...
const char winvncShareHWND[]		= "-sharehwnd";
const char winvncShareApp[]         = "-shareapp";

const char winvncAddNewClient[]		= "-connect";
const char winvncKillAllClients[]	= "-killallclients";

const char winvncChangePassword[]	= "-password";
...
const char winvncUsageText[] =
	...
	" [-sharewindow  \"title\"] [-sharehwnd HWND]\n"
	" [-shareapp pid] [-password pwd] [-about] [-help]\n";
