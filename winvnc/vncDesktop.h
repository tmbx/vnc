...
public:
	...
	void CaptureApplicationsFromAdapter(RECT UpdateArea, BYTE *scrBuff);
...
// created for debug purposes. not used in normal builds.
    ...
    virtual BOOL CreateWindowIcon(HDC hMemDC, HWND hWnd, rfbServerDataIconPrefReq iconPref, rfbServerDataIcon **iconData, ULONG *iconDataLength) {
        return m_wndmonitor->createWindowIcon(hMemDC, hWnd, iconPref, iconData, iconDataLength);
    }
    virtual BOOL CreateLauncherIcon(HDC hMemDC, ULONG id, rfbServerDataIconPrefReq iconPref, rfbServerDataIcon **iconData, ULONG *iconDataLength) {
        return m_wndmonitor->createLauncherIcon(hMemDC, id, iconPref, iconData, iconDataLength);
    }
    virtual BOOL DeleteIcon(rfbServerDataIcon *iconData) {
        return m_wndmonitor->deleteIcon(iconData);
    }
...
protected:
	...
	BOOL			m_hooks_active;
	BOOL			m_hooks_wndmsg_only;        // MetaVNC uses this
