...
public:
    ...
    // Whether or not to enable Meta Window Manager
	virtual void EnableMetaWindowManager(const BOOL enable) {m_enable_meta_wm = enable; RefreshWindowMonitor(); }
	virtual BOOL MetaWindowManagerEnabled() {return m_enable_meta_wm;}
	...
	virtual void SetAppShared(DWORD pid) { m_SharedPID = pid; }
	virtual DWORD GetAppShared() { return m_SharedPID; }
	virtual void AppShared(BOOL enable) { m_AppShared = enable; }
	virtual BOOL AppShared() { return m_AppShared; }
    ...
    //MetaVNC
    virtual void UpdateWindowStateRefresh();
    virtual void UpdateWindowState(HWND hWnd, ULONG state);
    virtual void UpdateWindowIcon(HWND hWnd);
    virtual void UpdateLauncher(ULONG id);
    virtual void UpdateTpRgn(vncRegion& incRgn, vncRegion& decRgn);
    virtual void ClearTpRgn();
    virtual void RefreshWindowMonitor();
    virtual void WindowControl(ULONG id, int control);
    virtual BOOL GetWindowName(HWND hWnd, char *name, int *len);
    virtual BOOL GetLauncherMenu(ULONG id, char **m_menupath, int *m_menupathlen);
    virtual BOOL CreateWindowIcon(HDC hMemDC, HWND hWnd, rfbServerDataIconPrefReq iconPref, rfbServerDataIcon **iconData, ULONG *iconDataLength);
    virtual BOOL CreateLauncherIcon(HDC hMemDC, ULONG id, rfbServerDataIconPrefReq iconPref, rfbServerDataIcon **iconData, ULONG *iconDataLength);
    virtual BOOL DeleteIcon(rfbServerDataIcon *iconData);
