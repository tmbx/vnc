...
protected:
	...
	BOOL m_pref_EnableMetaWindowManager;
	...
	BOOL m_pref_LogLots;
	int m_pref_Priority;
    BOOL m_pref_FullScreenShared;
    BOOL m_pref_PrimaryDisplayOnlyShared;
    BOOL m_pref_ScreenAreaShared;
    BOOL m_pref_WindowShared;
    int m_pref_ScreenAreaLeft;
    int m_pref_ScreenAreaTop;
    int m_pref_ScreenAreaRight;
    int m_pref_ScreenAreaBottom;
    HWND m_pref_SharedWindow;
